/**
 * Stage 6 (carvers): Runs 3D noise, cheese, noodle, spaghetti, and optional worm carving in order.
 */
...
/**
 * Creates the carvers stage: runs carve-3d, carve-cheese, carve-noodle, carve-spaghetti, then optional worm.
 */
