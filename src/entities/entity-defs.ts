...
export const ANIMAL_DEFS: AnimalDef[] = [
  ...
  },
  {
    ...
    walkSpeed: 1.4,
    runSpeed: 2.6,
    spawnBiomes: ['plains', 'forest', 'jungle', 'savanna'],
    maxPerChunk: 1,
    behaviour: 'passive',
    defaultDisposition: 'neutral',
    maxHealth: 10,
  ...
  },
  {
    ...
    walkSpeed: 1.5,
    runSpeed: 3.0,
    // Meadow spawns donkeys in vanilla; horse is used here as the closest existing stand-in.
    spawnBiomes: ['plains', 'savanna', 'meadow'],
    maxPerChunk: 1,
    behaviour: 'passive',
    defaultDisposition: 'neutral',
    maxHealth: 15,
