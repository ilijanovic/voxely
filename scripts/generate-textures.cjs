...
function createGrassTop() {
  ...
  const baseR = 0x5a, baseG = 0x9c, baseB = 0x38;
  const darkR = 0x48, darkG = 0x82, darkB = 0x2e;
  const scale = 0.15;
...
function createGrassSide() {
  const png = new PNG({ width: SIZE, height: SIZE });
  const grassR = 0x5a, grassG = 0x9c, grassB = 0x38;
  const dirtR = 0x72, dirtG = 0x52, dirtB = 0x3a;
...
function createSand() {
  const png = new PNG({ width: SIZE, height: SIZE });
  const baseR = 0xc8, baseG = 0xb4, baseB = 0x88;
  const scale = 0.15;
  for (let y = 0; y < SIZE; y++) {
    for (let x = 0; x < SIZE; x++) {
...
function createSnow() {
  const png = new PNG({ width: SIZE, height: SIZE });
  const baseR = 0xee, baseG = 0xf2, baseB = 0xfc;
  const shadowR = 0xd8, shadowG = 0xde, shadowB = 0xec;
  const scale = 0.12;
  for (let y = 0; y < SIZE; y++) {
    for (let x = 0; x < SIZE; x++) {
...
function createWood() {
  const png = new PNG({ width: SIZE, height: SIZE });
  const barkR = 0x58, barkG = 0x3c, barkB = 0x32;
  const grooveR = 0x42, grooveG = 0x2c, grooveB = 0x24;
  const scale = 0.08;
...
function createWoodTop() {
  const png = new PNG({ width: SIZE, height: SIZE });
  const centerX = SIZE / 2 - 0.5, centerZ = SIZE / 2 - 0.5;
  const ringR = 0x42, ringG = 0x2c, ringB = 0x24;
  const innerR = 0x58, innerG = 0x3c, innerB = 0x32;
  const scale = 0.1;
  for (let y = 0; y < SIZE; y++) {
    for (let x = 0; x < SIZE; x++) {
      const dx = x - centerX, dy = y - centerZ;
...
function createLeaves() {
  const png = new PNG({ width: SIZE, height: SIZE });
  const baseR = 0x32, baseG = 0x82, baseB = 0x38;
  const darkR = 0x24, darkG = 0x5c, darkB = 0x28;
  const scale = 0.2;
  for (let y = 0; y < SIZE; y++) {
    for (let x = 0; x < SIZE; x++) {
